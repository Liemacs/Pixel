                        ...
                        <div class="body">
                            <form action="{{ route('user.update', $user->id) }}" id="form_advanced_validation"
                                ...
                                <div class="form-group form-float" >
                                    <div class="form-line focused">
                                        <input type="text" class="form-control" name="full_name" maxlength="30" minlength="3"
                                            value="{{ $user->full_name }}" required autocomplete="off">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="email" class="form-control" name="email" maxlength="30" minlength="3"
                                            value="{{ $user->email }}" autocomplete="new-password">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="thumbnail" class="form-control" type="text" name="photo" autocomplete="off" value="{{ $user->photo }}">
                                </div>
